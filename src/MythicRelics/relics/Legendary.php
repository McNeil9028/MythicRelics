...
class Legendary implements Listener
{
    ...
    public function onTap(BlockPlaceEvent $event){
        ...
        switch($damage) {
            ...
            $item1->addEnchantment(new EnchantmentInstance($prot, 15));
            ...
            $item2->addEnchantment(new EnchantmentInstance($prot, 15));
            ...
            $item3->addEnchantment(new EnchantmentInstance($prot, 15));
            ...
            $item4->addEnchantment(new EnchantmentInstance($prot, 15));
            ...
            $sword->addEnchantment(new EnchantmentInstance($sharp, 15));
            ...
            $pickaxe->addEnchantment(new EnchantmentInstance($eff, 15));
            ...
            $axe->addEnchantment(new EnchantmentInstance($eff, 15));
