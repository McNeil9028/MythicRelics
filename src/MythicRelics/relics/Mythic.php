...
class Mythic implements Listener
{
    ...
    public function onTap(BlockPlaceEvent $event){
        ...
        switch($damage) {
            ...
            $item1->addEnchantment(new EnchantmentInstance($prot, 20));
            ...
            $item2->addEnchantment(new EnchantmentInstance($prot, 20));
            ...
            $item3->addEnchantment(new EnchantmentInstance($prot, 20));
            ...
            $item4->addEnchantment(new EnchantmentInstance($prot, 20));
            ...
            $sword->addEnchantment(new EnchantmentInstance($sharp, 20));
